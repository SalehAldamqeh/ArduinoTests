...
void loop() {
  ...
  String t= String(dht.getTemperatureC(),2);
  String h= String(dht.getHumidity(),2);
  display.clearDisplay();
  robojaxText("Voltage:          ", 4, 3, 1, false);
  robojaxText(vString, 72, 3, 1, false);
  robojaxText("V", 110, 3, 1, false);
  robojaxText("Temprature: ", 4, 11, 1, false);
  robojaxText(t, 72, 11, 1, false);
  robojaxText("C", 110, 11, 1, false);
  robojaxText("Humidity: ", 4, 21, 1, false);
  robojaxText(h, 72, 21, 1, false);
  robojaxText("%", 110, 21, 1, false);
